...
public class Grid {
    ...
    public Grid(String name, String imageUrl, String description,String availableon,String cast,String fav,String genre,String imagebackground,String ratings,String time,String trailer) {
        this.name = name;
